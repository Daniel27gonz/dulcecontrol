          ...
          {currentStep < ONBOARDING_STEPS.length ? (
            ...
            >
              ...
              <motion.div
                ...
                className="mx-auto w-32 h-32 rounded-3xl bg-gradient-to-br from-secondary to-accent flex items-center justify-center shadow-card"
              >
                <span className="text-6xl">{ONBOARDING_STEPS[currentStep].emoji}</span>
              </motion.div>
            ...
            >
              ...
              <div className="grid gap-2 max-h-80 overflow-y-auto scrollbar-hide">
                {CURRENCIES.map((currency) => (
                  ...
                  >
                    <div className="flex items-center gap-3">
                      <span className="w-10 h-10 rounded-full bg-card flex items-center justify-center font-bold text-caramel">
                        {currency.symbol}
                      </span>
